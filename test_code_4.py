...
main_path = "C:/Privat/Forschung/Forschungsabteilung/Social Devaluation/PsychoPy Experimente/SocDev/StimFiles/"
data_path = "C:/Privat/Forschung/Forschungsabteilung/Social Devaluation/PsychoPy Experimente/SocDev/Trial_Data/"
...
picture_files_34 = [
    main_path + "34-dots-400x400.bmp",
    main_path + "34-dots-400x400(1).bmp",
    main_path + "34-dots-400x400(2).bmp",
    main_path + "34-dots-400x400(3).bmp",
    main_path + "34-dots-400x400(4).bmp",
    main_path + "34-dots-400x400(5).bmp",
    main_path + "34-dots-400x400(6).bmp",
    main_path + "34-dots-400x400(7).bmp",
    main_path + "34-dots-400x400(8).bmp",
    main_path + "34-dots-400x400(9).bmp",
    main_path + "34-dots-400x400(10).bmp",
]

picture_files_36 = [
    main_path + "36-dots-400x400.bmp",
    main_path + "36-dots-400x400(1).bmp",
    main_path + "36-dots-400x400(2).bmp",
    main_path + "36-dots-400x400(3).bmp",
    main_path + "36-dots-400x400(4).bmp",
    main_path + "36-dots-400x400(5).bmp",
    main_path + "36-dots-400x400(6).bmp",
    main_path + "36-dots-400x400(7).bmp",
    main_path + "36-dots-400x400(8).bmp",
    main_path + "36-dots-400x400(9).bmp",
    main_path + "36-dots-400x400(10).bmp",
]
last_left_picture = last_right_picture = None # wird später in get_rnd_picture benötigt

spieler_bildpfade = {
    spieler_namen['spieler1']: main_path + "Dummy5_blau.bmp",
    spieler_namen['spieler2']: main_path + "Dummy5_gruen.bmp",
    spieler_namen['spieler3']: main_path + "Dummy5_rot.bmp",
}

sterne_bildpfade = [
    main_path + "3sterren.bmp", # sterne3_pfad = sterne_bildpfade[0]
    main_path + "2sterren.bmp", # sterne2_pfad = sterne_bildpfade[1]
    main_path + "1ster.bmp", # sterne1_pfad = sterne_bildpfade[2]
]

thumbup_pfad = main_path + "thumbup.bmp"
thumbdown_pfad = main_path + "thumbdown.bmp"
#endregion

#region - Instruktionen Setup und Anzeige
instruktionsbilder = [
    main_path + r"screenshot_initial.bmp",
    main_path + r"screenshot_gegner.bmp",
    main_path + r"screenshot_gegenueber.bmp",
    main_path + r"screenshot_darstellung.bmp",
    main_path + r"screenshot_hier_rel_up.bmp",
    main_path + r"screenshot_hier_rel_dev.bmp",
    main_path + r"screenshot_gleichI.bmp",
    main_path + r"screenshot_missfeedback.bmp",
    main_path + r"screenshot_abgestiegen.bmp",
    main_path + r"screenshot_abgestiegen.bmp",
]
...
#filename_exp_data = os.path.join(data_path, f"{date}_{participant_id}_{run_number}_exp_data.csv")
...
pulse = event.getKeys(keyList=['s'], timeStamped=True)
...
def get_and_show_feedback(trial_run=False):
    ...
    if response_spieler2:
        ...
        dir = response_spieler2[0] # prüfe nur den ersten gedrückten Key #EXPERIMENT STÜRZT AB, WENN KEINE TASTE GEDRÜCKT WIRD
    ...
    return time_ev2, response_spieler2, missing, accuracy_sp2, accuracy_op
